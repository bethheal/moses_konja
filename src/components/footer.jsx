          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full">
                ...
                <div
                  className="border border-red-950 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4"
                >
                  <input
                    type="email"
                    id="UserEmail"
                  ...
                  <button
                    className="mt-1 w-full bg-[#020617] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-[#020617] sm:mt-0 sm:w-auto sm:shrink-0"
                  >
                    Sign Up
                  </button>
                </div>
